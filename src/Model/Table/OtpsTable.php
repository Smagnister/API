 ...
 * @method \App\Model\Entity\Otp|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Otp saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
